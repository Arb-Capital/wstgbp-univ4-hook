...
/// @title IAggregatorV3
/// @notice Minimal Chainlink AggregatorV3Interface, vendored for the WETH/wstGBP venue
...
interface IAggregatorV3 {
    /// @notice Feed decimals (8 for the mainnet ETH/USD and GBP/USD feeds; asserted once at
    ///         deployment, never per swap).
