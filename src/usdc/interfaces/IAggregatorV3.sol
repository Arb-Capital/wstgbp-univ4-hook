...
/// @title IAggregatorV3
/// @notice Minimal Chainlink AggregatorV3Interface, vendored for the wstGBP/USDC venue
...
interface IAggregatorV3 {
    /// @notice Feed decimals (8 for the mainnet GBP/USD feed; asserted once at deployment,
    ///         never per swap).
